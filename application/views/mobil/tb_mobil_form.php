            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h2 class="box-title">Form Mobil</h2>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="decimal">HARGA SEWA MOBIL <?php echo form_error('HARGA_MOBIL') ?></label>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="BENSIN_MOBIL" id="BENSIN_MOBIL">
                                <option value="1" <?php if ($BENSIN_MOBIL==1) echo "selected" ?> >Automatic</option>
